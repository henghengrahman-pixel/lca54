...
app.post('/api/auth/login',(req,res)=>{
  ...
  loginAttempts.delete(ip); const token=sign({id,exp:Date.now()+12*60*60_000});
...
app.get('/api/health',(req,res)=>res.json({ok:true,service:'livechat-mischat-monitor',version:'1.0.3',admin_id_set:!!ADMIN_ID,admin_password_set:!!ADMIN_PASSWORD,session_secret_set:SESSION_SECRET.length>=24,extension_key_set:EXT_KEY.length>=24,time:new Date().toISOString()}));
